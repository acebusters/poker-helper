...
PokerHelper.prototype.isTurn = function isTurn(lineup, dealer, state, bbAmount, addr) {
  ...
  return this.getTurn(lineup, dealer, state, bbAmount) === pos;
};
 ...
 * @returns
 */
PokerHelper.prototype.getTurn = function getTurn(lineup, dealer, state, bbAmount) {
...
/**
 * @deprecated Since version 0.3.10. Please use getTurn(lineup, dealer, state, bbAmount) instead
 */
PokerHelper.prototype.whosTurn = function whosTurn(hand, bbAmount) {
  console.warn('deprecated: use getTurn(lineup, dealer, state, bbAmount) instead');
  return this.getTurn(hand.lineup, hand.dealer, hand.state, bbAmount);
};
