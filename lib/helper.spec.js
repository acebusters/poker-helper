...
describe('whosTurn() in state Dealing ', () => {
  ...
  it('should find BB when SB completes preflop.' , (done) => {
    ...
    expect(pokerHelper.whosTurn(hand, 50)).to.equal(2);
    done();
  });

  it('should find BB when SB completes preflop headsup.' , (done) => {
    let hand = {
      state: 'preflop',
      lineup: [{
          address: P_EMPTY
  ...
  it('should throw error with undefined BB.' , (done) => {
    let hand = {
      state: 'preflop',
      lineup: [{
          address: P1_ADDR,
    ...
    expect(pokerHelper.whosTurn.bind(pokerHelper, hand, undefined)).to.throw('BB cannot be undefined');
    done();
  });

  it('should thow Error if heads up and one sitout.' , (done) => {
    let hand = {
      state: 'dealing',
      lineup: [{
          address: P1_ADDR
    ...
    expect(pokerHelper.whosTurn.bind(pokerHelper, hand)).to.throw('no ones turn if only one or 0 player(s)');
    done();
  });

  it('should throw Error if hand state is waiting and not enough players.' , (done) => {
    let hand = {
      state: 'waiting',
      lineup: [{
          address: P1_ADDR
  ...
  it('should return small blind if hand state is waiting.' , (done) => {
    ...
    expect(pokerHelper.whosTurn(hand, 50)).to.equal(1);
    done();
  });

  it('should find turn of SB in state waiting headsup with sitouter.' , (done) => {
    let hand = {
      dealer: 1,
      state: 'waiting',
      lineup: [{
  ...
  it('should find turn of SB in state waiting with sitouter.' , (done) => {
    let hand = {
      dealer: 1,
      state: 'waiting',
      lineup: [{
  ...
  it('should identify pos of button.' , (done) => {
    ...
    expect(pokerHelper.whosTurn(hand, 50)).to.eql(1);
    done();
  });
  ...
  it('should find turn with empty seats.' , (done) => {
    ...
    expect(pokerHelper.whosTurn(hand, 50)).to.eql(3);
    done();
  });
...
describe('whosTurn() in state PreFlop ', () => {
  ...
  it('should find turn of SB.' , function(done) {
    ...
    expect(pokerHelper.whosTurn(hand, 50)).to.eql(0);
    done();
  });
  ...
  it('should find turn of SB with array wrap around.' , function(done) {
    ...
    expect(pokerHelper.whosTurn(hand, 50)).to.eql(2);
    done();
  });
  ...
  it('should find turn of UTG+1.' , function(done) {
    ...
    expect(pokerHelper.whosTurn(hand, 25)).to.eql(1);
    done();
  });
...
describe('whosTurn() in state Flop ', () => {
  ...
  it('should find turn with button checkPre.' , (done) => {
    ...
    expect(pokerHelper.whosTurn(hand, 50)).to.equal(4);
    done();
  });
  ...
  it('should find turn in CO to act on the flop when BB as first to act, checked the flop.' , (done) => {
    ...
    expect(pokerHelper.whosTurn(hand, 50)).to.equal(3);
    done();
  });
  ...
  it('should find turn of SB.', (done) => {
    ...
    expect(pokerHelper.whosTurn(hand, 25)).to.equal(2);
    done();
  });
  ...
  it('should find turn after last check.' , (done) => {
    ...
    expect(pokerHelper.whosTurn(hand, 5)).to.equal(3);
    done();
  });
  ...
  it('should find turn next after folded player.' , function(done) {
    ...
    expect(pokerHelper.whosTurn(hand, 5)).to.equal(1);
    done();
  });
  ...
  it('should find turn after uncalled bet.', (done) => {
    ...
    expect(pokerHelper.whosTurn(hand, 2.5)).to.equal(3);
    done();
  });
...
describe('whosTurn() in state Turn ', () => { 
  it('should distinguish between check rounds.', (done) => {
    ...
    expect(pokerHelper.whosTurn(hand, 10)).to.equal(0);
    done();
  });
...
describe('whosTurn() in state River ', () => {
  ...
  it('should find SB in turn after checkn in Turn (with wraparound).]', (done) => {
    ...
    expect(pokerHelper.whosTurn(hand, 50)).to.equal(0);
    done();
  });
});
...
describe('whosTurn() in state Showdown ', () => {
  ...
  it('should find last to show.' , (done) => {
    let hand = {
      state: 'showdown',
      lineup: [{
        address: P_EMPTY
...
describe('isBettingRoundDone() ', () => {
  ...
  it('should proceed to next round when bb folded.', (done) => {
    let lineup = [{
        address: P1_ADDR,
  ...
  it('should keep preflop until BB.', (done) => {
    let lineup = [{
        address: P1_ADDR,
        last: new EWT(ABI_BET).bet(1, 200).sign(P1_KEY)
      }, {
  ...
  it('should proceed to next round with folded player.', (done) => {
    let lineup = [{
        address: P1_ADDR,
        last: new EWT(ABI_BET).bet(1, 200).sign(P1_KEY)
      }, {
    ...
    expect(pokerHelper.allDone(lineup, 2, 'preflop', 200, 200)).to.equal(true);
    done();
  });

  it('`should complete preflop when bb timeoutet`', (done) => {
    let lineup = [{
        address: P1_ADDR,
        last: new EWT(ABI_BET).bet(1, 200).sign(P1_KEY)
      }, {
...
describe('maxBet() ', () => {
  it('should get max bet of lineup.', (done) => {
    ...
    expect(pokerHelper.findMaxBet(lineup, 0)).to.eql( { amount: 200, pos: 1 });
    done();
  });
...
describe('myMaxBet() ', () => {
  ...
  it('should return 0 if no receipt.', (done) => {
    let lineup = [{
        address: P1_ADDR
    }];
...
describe('getBbPos() ', () => {
  ...
  it('should find BB pos with preflop folder.', (done) => {
    let lineup = [{
        address: P1_ADDR,
        last: new EWT(ABI_FOLD).fold(1, 0).sign(P1_KEY)
      }, {
