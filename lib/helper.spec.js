...
describe('prevPlayer() ', () => {
  it('should find previous player', () => {
    const startPos = 0;
    const type = 'active';
    const state = 'flop';
    const lineup = [{
    ...
    // prevPlayer(lineup, startPos, type, state) {
    expect(pokerHelper.prevPlayer(lineup, startPos, type, state)).to.equal(2);
  });
  ...
  it('should find previous player', () => {
    ...
    // prevPlayer(lineup, startPos, type, state) {
    expect(pokerHelper.prevPlayer(lineup, startPos, type, state)).to.equal(1);
  });
});
