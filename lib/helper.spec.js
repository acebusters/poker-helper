...
// secretSeed: 'pony section spike blossom club amused keep will gorilla assist busy tray'
const ORACLE_ADDR = '0x0dfbfdf730c7d3612cf605e6629be369aa4eceeb';
const ORACLE_PRIV = '0xa803ed744543e69b5e4816c5fc7539427a2928e78d729c87712f180fae52fcc9';
...
describe('calcDistribution', () => {
  it('should calculate distribution.', () => {
    ...
    const lineup = [{
      ...
      address: P1_ADDR,
      last: new EWT(ABI_FOLD).fold(2, 500).sign(P1_KEY),
    }, {
      address: P2_ADDR,
      last: new EWT(ABI_BET).bet(2, 1000).sign(P2_KEY),
    }];
    ...
    expect(pokerHelper.calcDistribution(2, lineup, 'preflop', deck, 10, ORACLE_ADDR, ORACLE_PRIV)).to.equal(distHand2);
  });
});
