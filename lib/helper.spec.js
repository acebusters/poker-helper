...
describe('whosTurn in Dealing', () => {
  ...
  it('should identify right player with empty seats' , (done) => {
    let hand = {
      state: 'dealing',
      lineup: [{
          address: P1_ADDR,
...
describe('whosTurn in Flop', () => {
  ...
  it('should identify player in CO to act on the flop when BB as first to act, checked the flop' , (done) => {
    let hand = {
      state: 'flop',
      lineup: [{
          address: P1_ADDR,
  ...
  it('should not identify player who has folded as player to act', (done) => {
    let hand = {
      state: 'flop',
      lineup: [{
          address: P1_ADDR,
...
describe('getMyPos', () => {
  ...
  it('should get my position with empty', (done) => {
    let lineup = [{
        address: P_EMPTY,
      }, {
        address: P2_ADDR,
