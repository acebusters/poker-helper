...
describe('whosTurn() in state Dealing ', () => {
  ...
  it('should throw error with undefined BB.', (done) => {
    ...
    expect(pokerHelper.whosTurn.bind(pokerHelper, hand, undefined)).to.throw('BB amount cannot be undefined');
    done();
  });

  it('should throw Error if heads up and one sitout.', (done) => {
    const hand = {
      state: 'dealing',
      lineup: [{
        address: P1_ADDR,
    ...
    expect(pokerHelper.whosTurn.bind(pokerHelper, hand)).to.throw('no ones turn if hand complete.');
    done();
  });
  ...
  it('should find turn of BB when state dealing.', (done) => {
    const hand = {
      state: 'dealing',
      lineup: [{
        address: P1_ADDR,
  ...
  // TODO why is this needed?
  it('should identify pos of BB when state dealing with array wrap around.', (done) => {
    const hand = {
      state: 'dealing',
      lineup: [{
        address: P1_ADDR,
...
describe('whosTurn() in state PreFlop ', () => {
  ...
  it('should find turn of SB with array wrap around.', (done) => {
    const hand = {
      state: 'preflop',
      lineup: [{
        address: P1_ADDR, // BB
  ...
  it('should find turn when there are sitouts.', (done) => {
    const hand = {
      state: 'preflop',
      lineup: [{
        address: P1_ADDR,
  ...
  it('should find turn when there are timeouts.', (done) => {
    const hand = {
      state: 'preflop',
      lineup: [{
        address: P1_ADDR,
...
describe('whosTurn() in state Flop ', () => {
  ...
  it('should find turn of UTG+1 in flop.', (done) => {
    const hand = {
      state: 'flop',
      lineup: [{
        address: P1_ADDR,
  ...
  it('should find turn next after folded player.', (done) => {
    const hand = {
      state: 'flop',
      lineup: [{
        address: P1_ADDR,  // BB
  ...
  it('should find last active to call all in or turn.', (done) => {
    const hand = {
      state: 'flop',
      lineup: [{
        address: P1_ADDR,
