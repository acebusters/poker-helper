...
describe('getSbPos() ', () => {
  ...
  it('should find SB Pos for tournament tables.', () => {
    const lineup = [{
      address: P1_ADDR,
    }, {
      address: P2_ADDR,
    ...
    expect(pokerHelper.getSbPos(lineup, 0, 'waiting', 'tournament')).to.equal(1);
  });
...
describe('getBbPos() ', () => {
  ...
  it('should find BB Pos for tournament tables.', () => {
    const lineup = [{
      address: P1_ADDR,
    }, {
      address: P2_ADDR,
    ...
    expect(pokerHelper.getBbPos(lineup, 0, 'waiting', 'tournament')).to.equal(2);
  });
...
describe('calcDistribution', () => {
  ...
  it('should return distribution for sitout+fold case.', () => {
    expect(pokerHelper.calcDistribution([{
      address: P1_ADDR,
